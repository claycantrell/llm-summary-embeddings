...
**Author review.** The first author reviewed 121 reviews (50 where both models agreed, 71 where they disagreed). Manual inspection suggested that consensus labels were generally accurate. Disagreements reflected genuine multi-label ambiguity---reviews expressing multiple complaint types---rather than labeling errors.
